...
template<class T, class Comp >
void VS_EXPORTS index_sort(std::vector<T> &vec, size_t it_low, size_t it_high, std::vector<int> &index, Comp comp)
{
    if (it_low >= it_high)
    {
        //index[it_low] = it_low;
 ...
 template<class T> inline
     void VS_EXPORTS index_sort(std::vector<T> &vec, size_t it_low, size_t it_high, std::vector<int> &index)
{
